...
class IMU:
    ...
    ## @brief Check System Calibration 
    # 
    ...
    ## @brief Check Gyroscope Calibration 
    # 
    ...
    ## @brief Check Accelerometer Calibration 
    # 
    ...
    ## @brief Check Magnetometer Calibration 
    # 
    ...
    ## @brief Get the Accelerometer Calibration Coefficients 
    # 
    ...
    ## @brief Get the Magnetometer Calibration Coefficients 
    # 
    ...
    ## @brief Get the Gyroscope Calibration Coefficients 
    # 
    ...
    ## @brief Get the Accelerometer, Magnetometer and Gyroscope Calibration Coefficients Method
    # 
    ...
    ## @brief Change the IMU Operating Mode
    ...
    def get_Euler_z(self):
        ...
        x=(eul_z/900.00)
        return x
    ## @brief Get Yaw Angular Velocity data
    # 
    ...
    def get_Yaw_Velocity(self):
        ...
        x=(gyr_z/900.00)
        return x
    ## @brief Get Roll Angular Velocity data
    # 
    ...
    def get_Roll_Velocity(self):
        ...
        x=(gyr_x/900.00)
        return x
    ## @brief Get Pitch Angular Velocity data
    # 
