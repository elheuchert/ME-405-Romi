...
Below are the Finite State Machine transition diagrams for each task. They show the different states of the task, how they transition and what actions they take when transitioning.
 ...
 Figure 15. Control Task State Transition Diagram  Figure 16. Data Collector Task State Transition Diagram  Figure 17. UI Task State Transition Diagram  Figure 18. IMU Task State Transition Diagram  Figure 19. Motor Task State Transition Diagram  Figure 20. Pathing Plan Task State Transition Diagram\hypertarget{index_key}{}\doxysection{\texorpdfstring{Key takeaways}{Key takeaways}}\label{index_key}
